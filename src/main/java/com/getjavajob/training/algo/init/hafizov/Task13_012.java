...
public class Task13_012 {
    ...
    public static void init() {
        ...
        d.addEmployee("Olga", "Komkova","Andreevna", "str. dubrovskaya 7", 4, 2014);
        d.addEmployee("Pavel", "Semenov", "str. pedikovskaya 3", 11, 2011);
        d.addEmployee("Sergey", "Indukov", "str. pedikovskaya 3", 6, 2014);
        d.addEmployee("Mihail", "Sumkova", "Paketovich", "Str. babushkinskaya 12", 05, 2015);
        d.addEmployee("Nalia", "ivna", "str. pushkina 7", 4, 2014);
        d.addEmployee("Volia", "Babanov", "str. pedikovskaya 3", 11, 2011);
        d.addEmployee("Duba", "Dubonov", "str. Alexandrovskaya 3", 6, 2014);
    }
...
interface Finder{
    ...
    public int getWorkedYears(int month, int year, String name);
    public String printEmployeesWorkedOver3Years(int month, int year);
}

class Database implements Finder{
